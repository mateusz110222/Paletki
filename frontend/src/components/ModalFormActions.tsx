    ...
    return (
        <div className="flex gap-4 pt-4 border-t border-brand-border/60">
            ...
            <button
                ...
                className={`flex-1 min-h-12 px-4 font-black text-xs uppercase tracking-widest rounded-xl flex items-center justify-center gap-2 transition-all duration-200 shadow-[0_8px_18px_rgba(59,130,246,0.15)] hover:-translate-y-1 hover:scale-[1.02] active:translate-y-0 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none disabled:shadow-none motion-reduce:transform-none motion-reduce:transition-none ${submitColors}`}
            >
                {isSubmitting ? (
                    <>
