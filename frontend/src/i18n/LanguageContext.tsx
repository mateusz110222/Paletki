...
export const dictionaries = {
    pl: {
        ...
        cycle_step_description: 'Zwiększaj limit cykli po każdej określonej liczbie palet w zakresie.',
        ...
        cycle_step_preview: '{{count}} palet: {{first}}–{{groupEnd}} ma limit {{firstLimit}}; co {{every}} palet limit rośnie o {{amount}}. Ostatni limit: {{lastLimit}}.',
        cycle_step_preview_pending: 'Uzupełnij poprawny zakres i wartości skoku, aby zobaczyć podgląd.',
        cycle_step_invalid: 'Podaj dodatnie liczby całkowite dla skoku. Końcowy limit nie może przekroczyć 1 000 000 cykli.',
    ...
    en: {
        ...
        cycle_step_description: 'Increase the cycle limit after each specified number of pallets in the range.',
        cycle_step_every_label: 'Every pallets *',
        cycle_step_amount_label: 'Increase by *',
        label_nests: 'Nests',
        label_fis: 'FIS *',
        ...
        cycle_step_preview: '{{count}} pallets: {{first}}–{{groupEnd}} use {{firstLimit}}; every {{every}} pallets the limit increases by {{amount}}. Final limit: {{lastLimit}}.',
        cycle_step_preview_pending: 'Enter a valid range and step values to see the preview.',
        cycle_step_invalid: 'Enter positive integers for cycle stepping. The final limit may not exceed 1,000,000 cycles.',
