...
const pl = {
    ...
    cycle_step_invalid: "Skok limitu cykli wymaga dodatnich liczb całkowitych i nie może przekroczyć 1 000 000 cykli.",
...
const en: Record<TranslationKey, string> = {
    ...
    cycle_step_invalid: "Cycle limit stepping requires positive integers and may not exceed 1,000,000 cycles.",
