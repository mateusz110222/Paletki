...
const pl = {
    ...
    cycle_step_invalid: "Zmniejszanie limitu wymaga dodatnich liczb całkowitych. Każdy limit musi mieścić się w zakresie 1–1 000 000 cykli.",
...
const en: Record<TranslationKey, string> = {
    ...
    cycle_step_invalid: "Cycle limit decreases require positive integers. Each limit must be between 1 and 1,000,000 cycles.",
